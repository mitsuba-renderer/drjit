...
@pytest.test_arrays("float32, jit, diff, shape=(*)")
@pytest.mark.parametrize("auto_opaque", [False, True])
def test90_grad_doc(t, auto_opaque):
    """
...
@pytest.test_arrays("float32, jit, diff, shape=(*)")
@pytest.mark.parametrize("auto_opaque", [False, True])
def test91_refcycle(t, auto_opaque):
    """
...
@pytest.test_arrays("float32, jit, diff, shape=(*)")
@pytest.mark.parametrize("auto_opaque", [False, True])
def test93_exception(t, auto_opaque):
    """
...
@pytest.test_arrays("float32, jit, diff, shape=(*)")
@pytest.mark.parametrize("auto_opaque", [False, True])
def test94_vcall_exception(t, auto_opaque):
    """
    Tests that raising an exception inside a frozen function does not cause memory
