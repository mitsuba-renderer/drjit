...
def test68_state_decorator(t, auto_opaque):
    ...
    class MyClass:
        ...
        @dr.freeze(auto_opaque = auto_opaque, state=lambda self, *_, **__: (self.something2))
...
@pytest.mark.parametrize("auto_opaque", [False, True])
def test69_max_cache_size(t, auto_opaque, max_cache_size):
    """
    ...
    frozen = dr.freeze(func, auto_opaque=auto_opaque, max_cache_size=max_cache_size)
...
def test69_lru_eviction(t, auto_opaque):
    ...
    frozen = dr.freeze(func, auto_opaque=auto_opaque, max_cache_size=2)
...
def test70_warn_recordings(t, auto_opaque):
    ...
    frozen = dr.freeze(func, auto_opaque=auto_opaque, warn_recording_count=2)
...
@pytest.test_arrays("float32, jit, shape=(*)")
@pytest.mark.parametrize("auto_opaque", [False, True])
def test72_opaque_width(t, auto_opaque):
