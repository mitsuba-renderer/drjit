/*
    enoki/packet_kmask.h -- Abstraction around AVX512 'k' mask registers
...
struct KMaskBase : StaticArrayBase<Value_, Size_, true, Derived_> {
    ...
    static Register load_bool_(const void *data) {
        ...
        if constexpr (Size == 16)
            ...
            enoki_raise("KMaskBase: unsupported number of elements!");
    ...
    ENOKI_INLINE static Derived zero_(size_t) { return Derived::from_k(0); }
    ENOKI_INLINE static Derived empty_(size_t) { Derived d; return d; }
