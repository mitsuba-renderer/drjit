/*
    enoki/packet_sse42.h -- Packet arrays, SSE4.2 specialization
...
template <bool IsMask_, typename Derived_> struct alignas(16)
  ...
  : StaticArrayBase<float, 4, IsMask_, Derived_> {
    ...
    ENOKI_PACKET_TYPE(float, 4, __m128)
...
#  endif
    ...
    ENOKI_INLINE void store_aligned_(void *ptr) const {
    ...
    static ENOKI_INLINE Derived empty_(size_t) { return _mm_undefined_ps(); }
    static ENOKI_INLINE Derived zero_(size_t) { return _mm_setzero_ps(); }
...
template <typename Value_, bool IsMask_, typename Derived_> struct alignas(16)
  ...
  : StaticArrayBase<Value_, 4, IsMask_, Derived_> {
    ...
    ENOKI_PACKET_TYPE(Value_, 4, __m128i)
...
#  endif
    ...
    static ENOKI_INLINE Derived empty_(size_t) { return _mm_undefined_si128(); }
    static ENOKI_INLINE Derived zero_(size_t) { return _mm_setzero_si128(); }
...
template <bool IsMask_, typename Derived_> struct alignas(16)
  ...
  : StaticArrayBase<double, 2, IsMask_, Derived_> {
    ...
    ENOKI_PACKET_TYPE(double, 2, __m128d)
    ...
    static ENOKI_INLINE Derived zero_(size_t) { return _mm_setzero_pd(); }
    static ENOKI_INLINE Derived empty_(size_t) { return _mm_undefined_pd(); }
...
template <typename Value_, bool IsMask_, typename Derived_> struct alignas(16)
  ...
  : StaticArrayBase<Value_, 2, IsMask_, Derived_> {
    ...
    ENOKI_PACKET_TYPE(Value_, 2, __m128i)
...
// #endif
    ...
    static ENOKI_INLINE Derived load_aligned_(const void *ptr, size_t size) {
...
#if defined(ENOKI_X86_AVX512)
template <typename Derived_> ENOKI_DECLARE_KMASK(float,  4, Derived_, int)
template <typename Derived_> ENOKI_DECLARE_KMASK(float,  3, Derived_, int)
template <typename Derived_> ENOKI_DECLARE_KMASK(double, 2, Derived_, int)
