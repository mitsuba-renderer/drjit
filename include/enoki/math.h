...
ENOKI_INLINE Value estrin_impl(const Value &x, const Value (&coeff)[n]) {
...
template <typename Value, size_t n>
ENOKI_INLINE Value horner_impl(const Value &x, const Value (&coeff)[n]) {
...
ENOKI_INLINE Value estrin(const Value &x, Ts... ts) {
...
template <typename Value, typename... Ts>
ENOKI_INLINE Value horner(const Value &x, Ts... ts) {
    Value coeffs[] { scalar_t<Value>(ts)... };
