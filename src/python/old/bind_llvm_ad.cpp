...
void export_llvm_ad(nb::module_ &m) {
    nb::module_ llvm_ad = m.def_submodule("llvm").def_submodule("ad");
    ...
    nb::module_ detail = llvm_ad.def_submodule("detail");
    ...
    nb::class_<dr::Loop<Mask>>(llvm_ad, "LoopBase");

    nb::class_<Loop<Mask>, dr::Loop<Mask>> loop(llvm_ad, "Loop");
