...
.. drjit-namespace:: drjit.llvm.ad
   :title: LLVM array namespace with automatic differentiation (``drjit.llvm.ad``)

   The LLVM AD backend is vectorized, hence types listed as *scalar* actually
   represent an array of scalars partaking in a parallel computation
   (analogously, 1D arrays are arrays of 1D arrays, etc.).

.. drjit-namespace:: drjit.cuda
   :title: CUDA array namespace (``drjit.cuda``)

   The CUDA backend is vectorized, hence types listed as *scalar* actually
   represent an array of scalars partaking in a parallel computation
   (analogously, 1D arrays are arrays of 1D arrays, etc.).

.. drjit-namespace:: drjit.cuda.ad
   :title: CUDA array namespace with automatic differentiation (``drjit.cuda.ad``)

   The CUDA AD backend is vectorized, hence types listed as *scalar* actually
   represent an array of scalars partaking in a parallel computation
   (analogously, 1D arrays are arrays of 1D arrays, etc.).

.. drjit-namespace:: drjit.metal
   :title: Metal array namespace (``drjit.metal``)

   The Metal backend is vectorized, hence types listed as *scalar* actually
   represent an array of scalars partaking in a parallel computation
   (analogously, 1D arrays are arrays of 1D arrays, etc.).

.. drjit-namespace:: drjit.metal.ad
   :title: Metal array namespace with automatic differentiation (``drjit.metal.ad``)

   The Metal AD backend is vectorized, hence types listed as *scalar* actually
   represent an array of scalars partaking in a parallel computation
   (analogously, 1D arrays are arrays of 1D arrays, etc.).

.. drjit-namespace:: drjit.auto
   :title: Automatic array namespace (``drjit.auto``)

   The automatic backend by default wraps ``drjit.cuda`` when a CUDA-capable
   device was detected, ``drjit.metal`` on Apple platforms, and otherwise falls
   back to ``drjit.llvm``.

   You can use the function :py:func:`drjit.set_backend` to redirect this module.

   This backend is vectorized, hence types listed as *scalar* actually
   represent an array of scalars partaking in a parallel computation
   (analogously, 1D arrays are arrays of 1D arrays, etc.).

.. drjit-namespace:: drjit.auto.ad
   :title: Automatic array namespace with automatic differentiation (``drjit.auto.ad``)

   The automatic AD backend by default wraps ``drjit.cuda.ad`` when a
   CUDA-capable device was detected, ``drjit.metal.ad`` on Apple platforms, and
   otherwise falls back to ``drjit.llvm.ad``.
